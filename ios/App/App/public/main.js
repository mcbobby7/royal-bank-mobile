...
AccountInfoPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
...
let LimitComponent = class LimitComponent {
    constructor(toast, auth, router, currencyPipe) {
        this.toast = toast;
        this.auth = auth;
        this.router = router;
        ...
        this.formattedAmount1 = this.currencyPipe.transform('0', '₦');
    }
    ...
    transformAmount1(element) {
        this.formattedAmount1 = Number(this.formattedAmount1.replace(/[^0-9.-]+/g, '')).toString();
        this.formattedAmount1 = this.currencyPipe.transform(this.formattedAmount1, '₦');
    ...
    ngOnInit() {
        ...
        this.auth
            ...
            if (res.status === '00') {
                ...
                this.formattedAmount1 = this.currencyPipe.transform(res.data.data[0].intraLimit, '₦');
                this.formattedAmount = this.currencyPipe.transform(res.data.data[0].interLimit, '₦');
                // deal with register
            }
            else {
            }
...
LimitComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-limit',
...
let ChooseSigninComponent = class ChooseSigninComponent {
    constructor(router) {
        ...
        this.imageSrc = 'assets/icon/phone.png';
    }
    ngOnInit() { }
    sign() {
        this.router.navigate(['/login']);
...
LoanPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        selector: 'app-loan',
...
let NubanRegisterComponent = class NubanRegisterComponent {
    ...
    sanitize() {
        ...
        if (this.whatIs === 'ROYAL CORPORATE' ||
...
"use strict";
module.exports = ".overlay {\n  z-index: 999;\n  position: fixed;\n  /* Sit on top of the page content */\n  width: 100%;\n  /* Full width (cover the whole page) */\n  height: 100%;\n  /* Full height (cover the whole page) */\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n\n.mas {\n  z-index: 1000;\n  position: fixed;\n  /* Sit on top of the page content */\n  width: 100vw;\n  /* Full width (cover the whole page) */\n  height: 100vh;\n  /* Full height (cover the whole page) */\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n}\n\n.tran {\n  background-color: #f8f8f8;\n  padding: 10px;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  margin: 5px 0;\n}\n\n.tran .icon {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.tran .icon .text {\n  padding: 0 10px;\n}\n\n.tran .icon .text .tit {\n  font-size: 13px;\n  font-weight: 500;\n  padding: 0 3px;\n}\n\n.tran .icon .text .mode {\n  font-size: 11px;\n  color: #8d8d88;\n  padding: 0 3px;\n}\n\n.tran .amount {\n  font-size: 14px;\n  font-weight: 600;\n}\n\n.tran .red {\n  color: #d54b4b;\n}\n\n.tran .green {\n  color: #127e12;\n}\n\n.head {\n  background-color: #25214f;\n  color: white;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  position: relative;\n}\n\n.bod {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  margin-bottom: 60px;\n  padding-top: 20px;\n}\n\n.card {\n  background-color: #fff8f83c;\n  padding: 10px 20px;\n  font-size: 40px;\n  border-radius: 10px;\n}\n\n.date {\n  margin: 20px;\n}\n\ntable {\n  margin: 40px 0;\n  padding: 20px;\n  width: 95%;\n  margin: auto;\n}\n\nth,\ntd {\n  text-align: left;\n  padding-left: 20px;\n  font-size: 14px;\n}\n\ntr {\n  border-bottom: 1px solid #a19b9b;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = ".icon-container {\n  border-radius: 10%;\n  background-color: #25214f;\n  padding: 10px;\n}\n\nion-button {\n  --background: #d9ac0b;\n  --color: #25214f;\n  --background-activated: #25214f;\n  --color-activated: #fff;\n  --background-hover: #25214f;\n  --color-hover: #fff;\n}\n\nion-toggle {\n  --height: 15px;\n  --background-checked: #25214f;\n}\n\n.inner-icon {\n  font-size: 30px;\n  color: white;\n}\n\n.inBoth {\n  font-family: Mulish !important;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  align-items: center;\n  cursor: pointer;\n  margin: 1rem 0.5rem;\n  color: white;\n  background: #25214f;\n  border-radius: 10px;\n  padding: 10px;\n}\n\nspan {\n  font-family: Mulish !important;\n  display: flex !important;\n  align-self: center !important;\n}\n\nion-content {\n  font-family: Mulish !important;\n}\n\n.items {\n  margin: auto;\n  text-align: left;\n  padding-left: 20px;\n  font-size: 16px;\n  width: 100%;\n}\n\nion-popover {\n  --width: 22.5rem;\n}\n\n.userImg {\n  border-radius: 50% !important;\n  overflow: hidden;\n  width: 50px !important;\n  height: 50px !important;\n}\n\n.document {\n  display: flex;\n  justify-content: space-between;\n  flex-direction: row;\n  width: 95%;\n  padding: 20px;\n  margin: auto;\n  box-shadow: 0 10px 6px -6px #777;\n  border: 1px solid #c5c1c1;\n  align-items: center;\n  color: #25214f;\n  font-weight: 600;\n  margin-top: 30px;\n}\n\n.icn {\n  font-size: 25px;\n  color: #25214f;\n}\n\n.mod {\n  position: fixed;\n  top: 0;\n  left: 0;\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n\n.doc {\n  background-color: white;\n  box-shadow: 0 10px 6px -6px #777;\n  width: 90vw;\n  max-height: 80vh;\n  max-width: 500px;\n  padding: 30px 10px;\n  padding-bottom: 50px;\n  position: relative;\n  overflow-y: auto;\n}\n\n.head {\n  font-size: 20px;\n  font-weight: 600;\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = ".inner-icon {\n  font-size: 30px;\n  color: white;\n}\n\n.icon-container {\n  border-radius: 10%;\n  background-color: #25214f;\n  padding: 5px;\n}\n\n.header {\n  color: #25214f;\n  font-size: 16px;\n  font-weight: 800;\n}\n\nsection {\n  text-align: center;\n}\n\n.phoneField {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n\n.dialField {\n  width: 30% !important;\n}\n\n.numField {\n  width: 65% !important;\n}\n\n.row {\n  display: flex;\n  flex-direction: column;\n  align-content: flex-start;\n  padding-bottom: 1rem;\n  border-radius: 5px;\n}\n\ninput {\n  height: 15px;\n  width: 100%;\n  border: 0.8000000119px solid #ced4da;\n  border-radius: 5px;\n  background-color: #d5d4d4;\n  padding: 0px 25px;\n}\n\nion-content {\n  font-family: Mulish !important;\n}\n\n.form-inline [fullWidth] {\n  flex: 1;\n}\n\n.form-inline > * {\n  margin: 0 1.5rem 1.5rem 0;\n}\n\n.row-one {\n  border: 0.8000000119px solid #ced4da;\n  border-radius: 5px;\n  margin-top: 50px;\n  padding: 10px;\n}\n\nion-button {\n  --background: #d9ac0b;\n  --color: #fff !important;\n  color: #25214f;\n}\n\n.active {\n  width: 100%;\n  --border-radius: none;\n  --background: #25214f;\n  --color: white;\n  --color-activated: white;\n  color: white;\n}\n\n.input {\n  height: 3.2rem;\n  background: #e8e8e8;\n  border: 1px solid #b6b6b6;\n  box-sizing: border-box;\n  border-radius: 8px;\n}\n\nlabel {\n  color: #676767 !important;\n  text-align: left;\n}\n\n.title {\n  color: #25214f;\n  font-weight: 800;\n}\n\n.central-image {\n  display: flex;\n  flex-direction: column;\n  align-content: center;\n  margin-top: 30px;\n}\n\n.sub-title {\n  color: #676767;\n  text-align: center;\n}\n\n.link {\n  color: #25214f;\n  font-weight: 500;\n  text-decoration: none;\n}\n\n.img {\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.btn2 {\n  --background: #d9ac0b;\n  --color: #25214f;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #d9ac0b;\n}\n\nion-button {\n  --border-radius: 15px;\n}\n\n.content {\n  font-family: Mulish !important;\n  display: flex;\n  flex-direction: column;\n  align-content: space-between;\n}\n\n.img {\n  height: 290px;\n  width: 230px;\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.title {\n  color: #25214f;\n  font-weight: 800;\n}\n\n.central-image {\n  display: flex;\n  flex-direction: column;\n  align-content: center;\n}\n\n.sub-title {\n  color: #676767;\n}\n\nimg {\n  height: 291px;\n  width: 230px;\n}\n\n.tit {\n  font-family: Mulish !important;\n  font-style: normal;\n  font-weight: 800;\n  font-size: 24px;\n  line-height: 30px;\n  text-align: center;\n  color: #25214f;\n}\n\n.subTit {\n  font-family: Mulish !important;\n  font-style: normal;\n  font-weight: 400;\n  font-size: 15px;\n  line-height: 23px;\n  text-align: center;\n  color: #676767;\n  width: 300px;\n  margin-top: 20px;\n  margin-bottom: 40px;\n  margin: auto;\n}\n\nion-tab-bar {\n  --color: #d9ac0b;\n  --background: #25214f;\n}\n\n.icons {\n  height: 40px;\n  width: 40px;\n}\n\n.btn {\n  --background: #25214f;\n  --color: #fff;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #25214f;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = ".inner-icon {\n  font-size: 30px;\n  color: white;\n}\n\n.icon-container {\n  border-radius: 10%;\n  background-color: #25214f;\n  padding: 5px;\n}\n\n.header {\n  color: #25214f;\n  font-size: 16px;\n  font-weight: 800;\n}\n\nsection {\n  text-align: center;\n}\n\n.phoneField {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n\n.dialField {\n  width: 30% !important;\n}\n\n.numField {\n  width: 65% !important;\n}\n\n.row {\n  display: flex;\n  flex-direction: column;\n  align-content: flex-start;\n  padding-bottom: 1rem;\n  border-radius: 5px;\n}\n\nion-content {\n  font-family: Mulish !important;\n}\n\n.form-inline [fullWidth] {\n  flex: 1;\n}\n\n.form-inline > * {\n  margin: 0 1.5rem 1.5rem 0;\n}\n\n.row-one {\n  border: 0.8000000119px solid #ced4da;\n  border-radius: 5px;\n  margin-top: 50px;\n  padding: 10px;\n}\n\nion-button {\n  --background: #d9ac0b;\n  --color: #fff !important;\n  color: #25214f;\n}\n\n.active {\n  width: 100%;\n  --border-radius: none;\n  --background: #25214f;\n  --color: white;\n  --color-activated: white;\n  color: white;\n}\n\n.input {\n  height: 3.2rem;\n  background: #e8e8e8;\n  border: 1px solid #b6b6b6;\n  box-sizing: border-box;\n  width: 100%;\n  border: 0.8000000119px solid #ced4da;\n  border-radius: 10px;\n  padding: 0px 20px;\n}\n\nlabel {\n  color: #676767 !important;\n  text-align: left;\n}\n\n.title {\n  color: #25214f;\n  font-weight: 800;\n}\n\n.central-image {\n  display: flex;\n  flex-direction: column;\n  align-content: center;\n  margin-top: 30px;\n}\n\n.sub-title {\n  color: #676767;\n  text-align: center;\n}\n\n.link {\n  color: #25214f;\n  font-weight: 500;\n  text-decoration: none;\n}\n\n.img {\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.btn2 {\n  --background: #d9ac0b;\n  --color: #25214f;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #d9ac0b;\n}\n\n.content {\n  font-family: Mulish !important;\n  display: flex;\n  flex-direction: column;\n  align-content: space-between;\n}\n\n.img {\n  height: 290px;\n  width: 230px;\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.title {\n  color: #25214f;\n  font-weight: 800;\n}\n\n.central-image {\n  display: flex;\n  flex-direction: column;\n  align-content: center;\n}\n\n.sub-title {\n  color: #676767;\n}\n\nimg {\n  height: 291px;\n  width: 230px;\n}\n\n.tit {\n  font-family: Mulish !important;\n  font-style: normal;\n  font-weight: 800;\n  font-size: 24px;\n  line-height: 30px;\n  text-align: center;\n  color: #25214f;\n}\n\n.subTit {\n  font-family: Mulish !important;\n  font-style: normal;\n  font-weight: 400;\n  font-size: 15px;\n  line-height: 23px;\n  text-align: center;\n  color: #676767;\n  width: 300px;\n  margin-top: 20px;\n  margin-bottom: 40px;\n  margin: auto;\n}\n\nion-tab-bar {\n  --color: #d9ac0b;\n  --background: #25214f;\n}\n\n.icons {\n  height: 40px;\n  width: 40px;\n}\n\n.btn {\n  --background: #25214f;\n  --color: #fff;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #25214f;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = ".btn {\n  --background: #25214f;\n  --color: #fff;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #25214f;\n}\n\n.btn2 {\n  --background: #d9ac0b;\n  --color: #25214f;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #d9ac0b;\n}\n\nion-button {\n  --border-radius: 15px;\n}\n\nion-content {\n  font-family: Mulish !important;\n  --padding-end: 20px;\n  --padding-start: 20px;\n}\n\n.content {\n  display: flex;\n  flex-direction: column;\n  align-content: space-between;\n}\n\n.img {\n  height: 290px;\n  width: 230px;\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.title {\n  color: #25214f;\n  font-weight: 800;\n}\n\n.central-image {\n  display: flex;\n  flex-direction: column;\n  align-content: center;\n}\n\n.sub-title {\n  color: #676767;\n}\n\nimg {\n  height: 291px;\n  width: 230px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = "ion-content {\n  font-family: Mulish !important;\n}\n\n.btn {\n  font-family: Mulish !important;\n  --background: #25214f;\n  --color: #fff;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #25214f;\n}\n\n.inner-icon {\n  color: #fee178;\n}\n\n.icon-container {\n  border-radius: 10%;\n  background-color: #25214f;\n  padding: 10px;\n}\n\n.header {\n  color: #25214f;\n  font-size: 16px;\n  font-weight: 800;\n}\n\nsection {\n  text-align: center;\n}\n\n.phoneField {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n\n.dialField {\n  width: 30% !important;\n}\n\n.numField {\n  width: 65% !important;\n}\n\n.row {\n  display: flex;\n  flex-direction: column;\n  align-content: flex-start;\n  padding-bottom: 1rem;\n  border-radius: 5px;\n}\n\ninput {\n  height: 15px;\n  width: 100%;\n  border: 0.8000000119px solid #ced4da;\n  border-radius: 5px;\n  background-color: #d5d4d4;\n  padding: 0px 15px !important;\n}\n\n.form-inline [fullWidth] {\n  flex: 1;\n}\n\n.form-inline > * {\n  margin: 0 1.5rem 1.5rem 0;\n}\n\n.input {\n  height: 3.2rem;\n  background: #e8e8e8;\n  border: 1px solid #b6b6b6;\n  box-sizing: border-box;\n  border-radius: 5px;\n  padding: 0 15px;\n}\n\nlabel {\n  color: #676767 !important;\n  text-align: left;\n}\n\n.title {\n  color: #25214f;\n  font-weight: 800;\n}\n\n.central-image {\n  display: flex;\n  flex-direction: column;\n  align-content: center;\n  margin-top: 30px;\n}\n\n.sub-title {\n  color: #676767;\n  text-align: center;\n}\n\n.link {\n  color: #25214f;\n  font-weight: 500;\n  text-decoration: none;\n}\n\n.content {\n  display: flex;\n  flex-direction: column;\n  align-content: space-between;\n}\n\n.credit {\n  color: #25214f;\n}\n\n.debit {\n  color: #fee178;\n}\n\n.img {\n  height: 290px;\n  width: 230px;\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.btn2 {\n  font-family: Mulish !important;\n  --background: #fee178;\n  --color: #25214f;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #fee178;\n}\n\n.tra {\n  background-color: #f8f8f8;\n  padding: 10px;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  margin: 5px 0;\n}\n\n.tra .ico {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.tra .ico .tex {\n  padding: 0 10px;\n}\n\n.tra .ico .tex .ti {\n  font-size: 13px;\n  font-weight: 500;\n  text-align: left;\n  padding: 0 3px;\n}\n\n.tra .ico .tex .mod {\n  font-size: 11px;\n  color: #8d8d88;\n  padding: 0 3px;\n  text-align: left;\n}\n\n.tra .amount {\n  font-size: 14px;\n  font-weight: 600;\n}\n\n.tra .red {\n  color: #d54b4b;\n}\n\n.tra .green {\n  color: #127e12;\n}\n\n.mas {\n  z-index: 1000;\n  position: fixed;\n  /* Sit on top of the page content */\n  width: 100vw;\n  /* Full width (cover the whole page) */\n  height: 100vh;\n  /* Full height (cover the whole page) */\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n}\n\n.tes {\n  color: white;\n  font-size: 25px;\n  z-index: 1000;\n}\n\n.overlay {\n  z-index: 999;\n  position: fixed;\n  /* Sit on top of the page content */\n  width: 100%;\n  /* Full width (cover the whole page) */\n  height: 100%;\n  /* Full height (cover the whole page) */\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n\n.head {\n  background-color: #25214f;\n  color: white;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  position: relative;\n  padding-top: 70px;\n}\n\n.bod {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  margin-bottom: 60px;\n  padding-top: 20px;\n}\n\n.card {\n  background-color: #fff8f83c;\n  padding: 10px 20px;\n  font-size: 40px;\n  border-radius: 10px;\n}\n\n.date {\n  margin: 20px;\n}\n\ntable {\n  margin: 40px 0;\n  padding: 20px;\n  width: 95%;\n  margin: auto;\n}\n\nth,\ntd {\n  text-align: left;\n  padding-left: 20px;\n  font-size: 14px;\n}\n\ntr {\n  border-bottom: 1px solid #a19b9b;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = ".btn {\n  --background: #25214f;\n  --color: #fff;\n  text-transform: capitalize;\n  height: 3.5rem;\n  font-weight: 300;\n  font-size: 1.2rem;\n  --background-activated: #25214f;\n}\n\nion-button {\n  --border-radius: 15px;\n}\n\n.img {\n  height: 290px;\n  width: 230px;\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\nion-content {\n  --padding-end: 20px;\n  --padding-start: 20px;\n}\n\n.content {\n  display: flex;\n  flex-direction: column;\n  align-content: space-between;\n}\n\n.title {\n  color: #25214f;\n  font-style: normal;\n  font-weight: 800;\n  font-size: 36px;\n  line-height: 45px;\n}\n\nimg {\n  height: 291px;\n  width: 230px;\n}\n\n.sub {\n  font-style: normal;\n  font-weight: 300;\n  font-size: 16px;\n  line-height: 20px;\n  /* Grey Text */\n  color: #676767;\n}\n\n.skip {\n  font-style: normal;\n  font-weight: 300;\n  font-size: 18px;\n  line-height: 23px;\n  text-align: right;\n  color: #d9ac0b;\n  cursor: pointer;\n  padding: 10%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
